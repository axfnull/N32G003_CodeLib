...
void LED_GPIO_Config(void)
{
    ...
    /* Enable GPIO clock */
    RCC_APB_Peripheral_Clock_Enable(LED1_GPIO_CLK | LED2_GPIO_CLK | LED3_GPIO_CLK);
    ...
    /* close the all LED */
    GPIO_Pins_Reset(LED1_GPIO_PORT, LED1_GPIO_PIN);
    GPIO_Pins_Reset(LED2_GPIO_PORT, LED2_GPIO_PIN);
//    GPIO_Pins_Reset(LED3_GPIO_PORT, LED3_GPIO_PIN);
    GPIO_Pins_Set(LED3_GPIO_PORT, LED3_GPIO_PIN); //In order to adapt to the N32G003F5S7-STB development board, LED3 makes this special configuration.
}
